...
const Header = () => {
    ...
    <header className='fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary'>
        ...
        <div className='hidden md:flex w-full h-full items-center justify-between'>
            ...
            <p className='text-headingColor text-xl font-bold'>U-Canteen</p>
            </Link>
            ...
            <div className='relative flex items-center justify-center cursor-pointer'>
                ...
                right-0'>
                 {user && user.email === "nadalutfiyah1@gmail.com" && (
                <Link to={"/createItem"}>
                ...
                <li className='text-base text-textColor
                 hover:text-headingColor duration-100
                  transition-all ease-in-out cursor-pointer
                   ...
                   <p className='m-2 p-2 flex rounded-md shadow-md items-center justify-center bg-gray-200 gap-3 cursor-pointer
