...
<div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
      ...
      cursor-pointer rounded-lg'>
              {isLoading ? <Loader />:<>
                    {!imageAsset ? (
                    <>
                    <label className='w-full h-full flex-col items-center
                    ...
                    <><div className='relative h-full'>
                      ...
                      <button type='buttom' className='absolute bottom-3
      ...
      <div className='flex items-center w-full'>
        ...
        border-none outline-none bg-emerald-500 px-12 py02 rounded-lg
